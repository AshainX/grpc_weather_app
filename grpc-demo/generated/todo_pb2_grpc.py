...
class TodoServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateTodo = channel.unary_unary(
                ...
                response_deserializer=todo__pb2.TodoActionResponse.FromString,
        ...
        self.ListTodos = channel.unary_unary(
                ...
                _registered_method=True)
        self.ToggleTodoComplete = channel.unary_unary(
                '/todo.TodoService/ToggleTodoComplete',
                request_serializer=todo__pb2.GetTodoRequest.SerializeToString,
                response_deserializer=todo__pb2.TodoActionResponse.FromString,
                _registered_method=True)
        self.ClearCompletedTodos = channel.unary_unary(
                '/todo.TodoService/ClearCompletedTodos',
                request_serializer=todo__pb2.ListTodosRequest.SerializeToString,
                response_deserializer=todo__pb2.TodoActionResponse.FromString,
                _registered_method=True)
...
def add_TodoServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateTodo': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=todo__pb2.TodoActionResponse.SerializeToString,
            ),
            ...
            'ToggleTodoComplete': grpc.unary_unary_rpc_method_handler(
                    servicer.ToggleTodoComplete,
                    request_deserializer=todo__pb2.GetTodoRequest.FromString,
                    response_serializer=todo__pb2.TodoActionResponse.SerializeToString,
            ),
            'ClearCompletedTodos': grpc.unary_unary_rpc_method_handler(
                    servicer.ClearCompletedTodos,
                    request_deserializer=todo__pb2.ListTodosRequest.FromString,
                    response_serializer=todo__pb2.TodoActionResponse.SerializeToString,
            ),
    }
...
class TodoService(object):
    ...
    def CreateTodo(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            todo__pb2.TodoActionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def ToggleTodoComplete(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def ClearCompletedTodos(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
