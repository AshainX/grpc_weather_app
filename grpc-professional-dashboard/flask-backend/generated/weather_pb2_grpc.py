...
def add_WeatherServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetForecast': grpc.unary_stream_rpc_method_handler(
                    servicer.GetForecast,
                    request_deserializer=weather__pb2.ForecastRequest.FromString,
                    response_serializer=weather__pb2.ForecastDay.SerializeToString,
            ),
    }
...
class WeatherService(object):
    ...
    def GetForecast(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            weather__pb2.ForecastDay.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
